...
p.D_s_n = 3.9e-14;  % Diffusion coeff for solid in neg. electrode, [m^2/s] ADJUSTED FOR OLD MODEL
p.D_s_p = 1e-13/2;  % Diffusion coeff for solid in pos. electrode, [m^2/s] ADJUSTED FOR OLD MODEL
...
p.R_SEI = 1e-3*5;       % Resistivity of SEI layer, [Ohms*m^2]  ADJUSTED FOR OLD MODEL
...
p.h = 0.36 * 5/6;   % Heat transfer coefficient, [W/K-m^2] ADJUSTED FOR OLD MODEL
