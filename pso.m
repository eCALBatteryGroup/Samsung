...
%     fprintf(1,'pval : %3.6f\n',pval);
%     fprintf(1,'state.pbestval : %3.6f\n',state.pbestval);

%fprintf('state.pbestval : %3.6f\n',abcd);
% fprintf('\n');
%    fprintf(' pval_size : %d',size(pval));
% fprintf('\n');
%    fprintf(' state.pbestval_size : %d',size(state.pbestval));
%    sat=pval<state.pbestval;
   %fprintf('check 3 : %3.1f\n',sat); 

%    fprintf('check 1 : %3.6f\n',state.P(pval<state.pbestval,:)); 
%    fprintf('check 2 : %3.6f\n',state.pos(pval<state.pbestval,1:nvars)); 
