...
% Load NMC Params \\Lithium Cobolt Oxide Params, adopted from DUALFOIL
...
[A_csn,B_csn,A_csp,B_csp,C_csn,C_csp,A_csn_normalized, A_csp_normalized] = c_s_mats_RG(p);
p.A_csn = A_csn;
...
for k = 1:(NT-1)
    ...
    [A_csn,B_csn,A_csp,B_csp,C_csn,C_csp] = c_s_mats_RG(p);
    p.A_csn = A_csn;
    p.B_csn = B_csn;
    p.A_csp = A_csp;
    p.B_csp = B_csp;
