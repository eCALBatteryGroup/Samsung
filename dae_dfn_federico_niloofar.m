...
function [f, g, varargout] = dae_dfn_federico_niloofar(x,z,Cur,p)
%% Parse out states
...
c_ss_p_0p =  c_ss_p(1); % Niloofar add
c_ss_p_Lp = c_ss_p(end); % Niloofar add
c_ss_n_0n =  c_ss_n(1); % Niloofar add
c_ss_n_Ln = c_ss_n(end); % Niloofar add
...
varargout{1} = [c_ss_n; c_ss_p; c_avg_n; c_avg_p; c_ex; eta_n; eta_p;...
    ...
    Volt; nLi; nLidot; ...
    c_ss_p_0p;c_ss_p_Lp;c_ss_n_0n;c_ss_n_Ln]; % Niloofar added
