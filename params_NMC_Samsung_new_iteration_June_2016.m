...
%  
% p.epsilon_f_n = 0.1147;%0.0789;%0;%Filler
% p.epsilon_f_p = 0.0636;%0.0998;%0;%Filler
% 
...
% p.D_e = 4e-10;% 6.9726e-9;%2.0864e-9; %2.0864e-10;%1.50E-10; %6.911e-10;    % Diffusion coeff for electrolyte, [m^2/s]
%  
...
%  
% % Miscellaneous
% p.t_plus = 0.3650;%0.38; %0.2495;    % Transference number
...
% p.R_f_n = 0; %p.R_SEI;    % Resistivity of SEI layer, [Ohms*m^2]
% p.R_f_p = 1e-3; %0;          % Resistivity of SEI layer, [Ohms*m^2]
