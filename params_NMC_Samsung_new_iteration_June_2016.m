...
% Particle Radii
p.R_s_n = 1e-6;% 6.1708e-07;%5e-7;%1e-7;%5.00E-7;%5.00E-06; %3.596e-6;   % Radius of solid particles in negative electrode [m]
p.R_s_p = 1e-6;%5.0000e-07;%5e-7;%1e-7;%5.00E-7; %1.637e-7;   % Radius of solid particles in positive electrode [m]
...
%% Transport Params
% Diffusion coefficient in solid
%p.D_s_n = 8.9931e-14;%8.8565e-13;%9.9945e-13;%1.40E-14; %1.736e-14;  % Diffusion coeff for solid in neg. electrode, [m^2/s]
%p.D_s_p = 9.9748e-14;%6.6027e-12;%1.0000e-14;%2.00E-14; %8.256e-14;  % Diffusion coeff for solid in pos. electrode, [m^2/s]
...
% Diffusion coefficient in electrolyte
%p.D_e = 5e-10; %2.0864e-10;%1.50E-10; %6.911e-10;    % Diffusion coeff for electrolyte, [m^2/s]
...
p.alph = 0.5;         % Charge transfer coefficients
p.R_SEI = 0;%3.391e-3;   % Resistivity of SEI layer, [Ohms*m^2]
% p.R_f_n = 1.00E-03; %p.R_SEI;    % Resistivity of SEI layer, [Ohms*m^2]
% p.R_f_p = 5.00E-03; %0;          % Resistivity of SEI layer, [Ohms*m^2]
%p.R_c = 5.1874e-05;%4.0000e-06;%7.00E-04; %0;          % Contact Resistance/Current Collector Resistance, [Ohms*m^2]
%p.R_c = 0;%1.0000e-05;
