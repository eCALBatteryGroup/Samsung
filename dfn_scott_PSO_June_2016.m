...
run params_NMC_Samsung_new_iteration_June_2016 %params_NMC_Samsung_new_iteration
...
load('data/Int_Obs/UDDS_data_Oct_26_2015_Sample_05sec');%load('data/Int_Obs/dfn_5c');%load('data/Int_Obs/UDDS_data_Oct_26_2015_Sample_05sec'); 
...
% Solid concentration
V0 = 3.932250528000001;% 3.6659;% for 5C pulse  ||     3.932250528000001; % For Samsung UDDS; 
