...
function [f, g, varargout] = dae_dfn_federico_scott(x,z,Cur,p)
%% Parse out states
...
[D_en,dD_en] = electrolyteDe_NCM(c_en,p);
[D_es,dD_es] = electrolyteDe_NCM(c_es,p);
[D_ep,dD_ep] = electrolyteDe_NCM(c_ep,p);
...
Unref = refPotentialAnode_NCM20Q(p, theta_n);
Upref = refPotentialCathode_NCM20Q(p, theta_p);
...
[Unb,~,dUnbdT] = refPotentialAnode_NCM20Q(p, theta_avg_n);
[Upb,~,dUpbdT] = refPotentialCathode_NCM20Q(p, theta_avg_p);
